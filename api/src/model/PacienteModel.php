...
class PacienteModel
{
    ...
    //crear pacientes
    public function createPaciente($dni_paciente, $nombre, $apellido, $correo, $direccion, $provincia, $region, $sexo, $nroTelefonico)
    {
    ...
    public function findByIdPaciente($id_paciente)
    {
    ...
    // Actualizar paciente
    public function updatePaciente($id_paciente, $dni_paciente, $nombre, $apellido, $correo, $direccion, $provincia, $region, $sexo, $nroTelefonico)
    {
